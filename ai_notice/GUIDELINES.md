...
## 未來擴充規劃
- **AI 深度解卦**：串接 LLM API，根據使用者的具體問題、本卦、變卦與動爻，給出客製化的白話文建議。
- **歷史與哲學知識庫 (RAG)**：導入 RAG (Retrieval-Augmented Generation) 技術，將易經的歷史背景與哲學故事向量化，讓 AI 解卦時能引用更豐富的典故。
